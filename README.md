...
- [Summary](#summary)
- [Intended key features](#intended-key-features)
...
* National
  * [Geoscience Australia - All recent](https://earthquakes.ga.gov.au/feeds/all_recent.atom), [More Info](https://earthquakes.ga.gov.au) (tap on Notofications).
* New South Wales
  * Rural Fire Service
...
* [Western Australia](https://www.emergency.wa.gov.au/about#rss).
  * [Emergency WA](https://api.emergency.wa.gov.au/v1/capau)
